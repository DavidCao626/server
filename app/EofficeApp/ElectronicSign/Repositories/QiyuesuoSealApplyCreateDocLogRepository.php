...
use App\EofficeApp\ElectronicSign\Entities\QiyuesuoSealApplyCreateDocLogEntity;

class QiyuesuoSealApplyCreateDocLogRepository extends BaseRepository
{
    public function __construct(QiyuesuoSealApplyCreateDocLogEntity $entity)
    {
