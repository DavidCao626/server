...
use App\EofficeApp\Calendar\Entities\calendarPurviewRoleEntity;
 ...
 *
 */
class CalendarSharePurviewRoleRepository extends BaseRepository 
{
    ...
    public function __construct(calendarPurviewRoleEntity $entity) 
    {
