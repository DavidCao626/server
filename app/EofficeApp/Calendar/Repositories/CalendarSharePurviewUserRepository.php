...
use App\EofficeApp\Calendar\Entities\calendarPurviewUserEntity;
 ...
 *
 */
class CalendarSharePurviewUserRepository extends BaseRepository 
{
    ...
    public function __construct(calendarPurviewUserEntity $entity) 
    {
