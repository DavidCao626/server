...
use App\EofficeApp\Calendar\Entities\calendarPurviewDeptEntity;
 ...
 *
 */
class CalendarSharePurviewDeptRepository extends BaseRepository 
{
    ...
    public function __construct(calendarPurviewDeptEntity $entity) 
    {
