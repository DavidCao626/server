...
use App\EofficeApp\Diary\Entities\DiaryPlanLogEntity;
 ...
 * @since  2015-10-20 创建
 */
class DiaryPlanLogRepository extends BaseRepository
{
    public function __construct(DiaryPlanLogEntity $entity)
    {
