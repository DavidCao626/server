...
use App\EofficeApp\Diary\Entities\DiaryPlanContentBlockEntity;
 ...
 * @since  2015-10-20 创建
 */
class DiaryPlanContentBlockRepository extends BaseRepository
{
    public function __construct(DiaryPlanContentBlockEntity $entity)
    {
