...
class PushLogConfig extends BasePush
{
...
";
    ...
    {       
        parent::__construct();
        if (!is_dir($this->loggerPath . 'hwPush')) {
            mkdir($this->loggerPath . 'hwPush', 0777);
        }
        $this->LogFile = @fopen($this->loggerPath.'/hwPush/'.Constants::HW_PUSH_LOG_FILE_NAME, 'a+');
